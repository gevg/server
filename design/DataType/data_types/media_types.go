...
var BackboneElementMedia = MediaType("application/vnd.BackboneElement+json", func() {
...
var ContactPointMedia = MediaType("application/vnd.ContactPoint+json", func() {
...
var HumanNameMedia = MediaType("application/vnd.HumanName+json", func() {
...
var SampleDataMedia = MediaType("application/vnd.sample.data+json", func() {
	...
	View("default", func() {
		Description("Default view of SampleData element")
		Attribute("origin")
		Attribute("period")
		Attribute("factor")
		Attribute("lowerLimit")
...
var SignatureMedia = MediaType("application/vnd.signature+json", func() {
	TypeName("SignatureDataMedia")
	Reference(SignaturePayload)
	Attributes(func() {
		Attribute("type")
		Attribute("when")
		Attribute("whoUri")
		Attribute("whoReference")
		Attribute("contentType")
		Attribute("blob")
	})
	View("default", func() {
		Description("Default view of Signature element")
		Attribute("type")
		Attribute("when")
		Attribute("whoUri")
		Attribute("whoReference")
