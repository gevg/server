...
var OAuth2TokenMedia = MediaType("application/vnd.goa.fhir.oauth2.token+json", func() {
...
var OAuth2ErrorMedia = MediaType("application/vnd.goa.fhir.oauth2.error+json", func() {
...
var SuccessMedia = MediaType("application/vnd.goa.fhir.security.success", func() {
