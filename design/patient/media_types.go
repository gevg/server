...
var Patient = MediaType("application/vnd.patient+json", func() {
	...
	Attributes(func() {
		...
		Attribute("identifier", Identifier, "Patient identifer", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
		...
		// Attribute("name", HumanName, "A name associated with the individual.", func() {
		// 	//Comments:
		// 	//Reason for inclusion or contrainment:
		// })
		Attribute("telecom", ContactPoint, "A contact detail (e.g. a telephone number or an email address) by which the individual may be contacted..", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
		...
		Attribute("address", Address, "Addresses for the individual.", func() {
		...
		Attribute("photo", Attachment, "", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
		Attribute("contact", HL7Contact, "", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
		Attribute("animal", Animal, "", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
		Attribute("communication", Communication, "", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
		...
		Attribute("link", HL7Link, "Link to another patient resource that concerns the same actual patient.", func() {
			//Comments:
			//Reason for inclusion or contrainment:
		})
	})
	...
	View("tiny", func() {
		Description("tiny is the view used to list patients")
		Attribute("id")
		Attribute("href")
		//Attribute("name")
	})
