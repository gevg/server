...
// DecodeAllergyIntoleranceFull decodes the AllergyIntoleranceFull instance encoded in resp body.
func (c *Client) DecodeAllergyIntoleranceFull(resp *http.Response) (*AllergyIntoleranceFull, error) {
	var decoded AllergyIntoleranceFull
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// DecodeAllergyIntoleranceTiny decodes the AllergyIntoleranceTiny instance encoded in resp body.
func (c *Client) DecodeAllergyIntoleranceTiny(resp *http.Response) (*AllergyIntoleranceTiny, error) {
	var decoded AllergyIntoleranceTiny
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeAllergyIntoleranceTinyCollection decodes the AllergyIntoleranceTinyCollection instance encoded in resp body.
func (c *Client) DecodeAllergyIntoleranceTinyCollection(resp *http.Response) (AllergyIntoleranceTinyCollection, error) {
	var decoded AllergyIntoleranceTinyCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}

// This patient is known to be an animal. (default view)
//
...
// Languages which may be used to communicate with the patient about his or her health. (default view)
//
...
// A contact party (e.g. guardian, partner, friend) for the patient. (default view)
//
...
// Validate validates the Contact media type instance.
func (mt *Contact) Validate() (err error) {
	if mt.Address != nil {
...
// A human's name with the ability to identify parts and usage. (default view)
//
...
// A technical identifier - identifies some entity uniquely and unambiguously. (default view)
//
...
// Link to another patient resource that concerns the same actual patient. (default view)
//
...
// Validate validates the Link media type instance.
func (mt *Link) Validate() (err error) {
	if mt.Type != nil {
...
func (mt *NutritionRequest) Validate() (err error) {
	...
	if mt.Supplement != nil {
		if err2 := mt.Supplement.Validate(); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
func (ut *NutritionRequestLinks) Validate() (err error) {
	...
	if ut.Supplement != nil {
		if err2 := ut.Supplement.Validate(); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// DecodeNutritionRequestFull decodes the NutritionRequestFull instance encoded in resp body.
func (c *Client) DecodeNutritionRequestFull(resp *http.Response) (*NutritionRequestFull, error) {
	var decoded NutritionRequestFull
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// DecodeNutritionRequestTiny decodes the NutritionRequestTiny instance encoded in resp body.
func (c *Client) DecodeNutritionRequestTiny(resp *http.Response) (*NutritionRequestTiny, error) {
	var decoded NutritionRequestTiny
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeNutritionRequestTinyCollection decodes the NutritionRequestTinyCollection instance encoded in resp body.
func (c *Client) DecodeNutritionRequestTinyCollection(resp *http.Response) (NutritionRequestTinyCollection, error) {
	var decoded NutritionRequestTinyCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
...
func (mt *Patient) Validate() (err error) {
	...
	if mt.Link != nil {
		if err2 := mt.Link.Validate(); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	if mt.Photo != nil {
		if err2 := mt.Photo.Validate(); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// Demographics and other administrative information about an individual or animal receiving care or other health-related services. (link view)
//
...
// Demographics and other administrative information about an individual or animal receiving care or other health-related services. (tiny view)
//
// Identifier: application/vnd.patient+json; view=tiny
type PatientTiny struct {
	// API href of patient
	Href string `form:"href" json:"href" xml:"href"`
	// ID of patient
	ID int `form:"id" json:"id" xml:"id"`
...
// Validate validates the PatientTiny media type instance.
func (mt *PatientTiny) Validate() (err error) {
...
// DecodePatientTiny decodes the PatientTiny instance encoded in resp body.
func (c *Client) DecodePatientTiny(resp *http.Response) (*PatientTiny, error) {
	var decoded PatientTiny
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// Validate validates the PatientLinkCollection media type instance.
func (mt PatientLinkCollection) Validate() (err error) {
	for _, e := range mt {
		if e != nil {
			if err2 := e.Validate(); err2 != nil {
				err = goa.MergeErrors(err, err2)
...
// PatientCollection is the media type for an array of Patient (tiny view)
//
// Identifier: application/vnd.patient+json; type=collection; view=tiny
type PatientTinyCollection []*PatientTiny

// Validate validates the PatientTinyCollection media type instance.
func (mt PatientTinyCollection) Validate() (err error) {
	for _, e := range mt {
		if e != nil {
			if err2 := e.Validate(); err2 != nil {
				err = goa.MergeErrors(err, err2)
...
// DecodePatientTinyCollection decodes the PatientTinyCollection instance encoded in resp body.
func (c *Client) DecodePatientTinyCollection(resp *http.Response) (PatientTinyCollection, error) {
	var decoded PatientTinyCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
