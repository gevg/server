...
//
// API "Secure": patient Resource Client
//
...
func (c *Client) NewCreatePatientRequest(ctx context.Context, path string, payload *CreatePatientPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp179 := strconv.Itoa(*count)
		values.Set("_count", tmp179)
	}
	if elements != nil {
	...
	if id != nil {
		tmp180 := strconv.Itoa(*id)
		values.Set("_id", tmp180)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp181 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp181)
	}
	if list != nil {
...
func (c *Client) NewDeletePatientRequest(ctx context.Context, path string, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp182 := strconv.Itoa(*count)
		values.Set("_count", tmp182)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp183 := strconv.Itoa(*id)
		values.Set("_id", tmp183)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp184 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp184)
	}
	if list != nil {
		values.Set("_list", *list)
	}
...
func (c *Client) NewReadPatientRequest(ctx context.Context, path string, payload *PatientPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp185 := strconv.Itoa(*count)
		values.Set("_count", tmp185)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp186 := strconv.Itoa(*id)
		values.Set("_id", tmp186)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp187 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp187)
	}
	if list != nil {
		values.Set("_list", *list)
	}
...
// SearchPatientPath2 computes a request path to the search action of patient.
func SearchPatientPath2() string {
...
func (c *Client) NewSearchPatientRequest(ctx context.Context, path string, payload *PatientPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string, active *bool, birthDate []time.Time, gender *string, name []string) (*http.Request, error) {
	...
	if count != nil {
		tmp188 := strconv.Itoa(*count)
		values.Set("_count", tmp188)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp189 := strconv.Itoa(*id)
		values.Set("_id", tmp189)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp190 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp190)
	}
	if list != nil {
		values.Set("_list", *list)
	}
	...
	if active != nil {
		tmp191 := strconv.FormatBool(*active)
		values.Set("active", tmp191)
	}
	for _, p := range birthDate {
		tmp192 := p.Format(time.RFC3339)
		values.Add("birthDate", tmp192)
	}
	if gender != nil {
...
func (c *Client) NewUpdatePatientRequest(ctx context.Context, path string, payload *UpdatePatientPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp194 := strconv.Itoa(*count)
		values.Set("_count", tmp194)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp195 := strconv.Itoa(*id)
		values.Set("_id", tmp195)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp196 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp196)
	}
	if list != nil {
		values.Set("_list", *list)
	}
...
func (c *Client) NewVreadPatientRequest(ctx context.Context, path string, payload *PatientPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp197 := strconv.Itoa(*count)
		values.Set("_count", tmp197)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp198 := strconv.Itoa(*id)
		values.Set("_id", tmp198)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp199 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp199)
	}
	if list != nil {
		values.Set("_list", *list)
	}
