...
func (c *Client) SecureJWT(ctx context.Context, path string, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string, fail *bool) (*http.Response, error) {
	req, err := c.NewSecureJWTRequest(ctx, path, contained, containedType, count, elements, has, id, include, lastUpdate, list, profile, query, revinclude, security, sort, summary, tag, text, type_, fail)
	if err != nil {
		return nil, err
	}
...
func (c *Client) NewSecureJWTRequest(ctx context.Context, path string, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string, fail *bool) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
	...
	if count != nil {
		tmp166 := strconv.Itoa(*count)
		values.Set("_count", tmp166)
	}
	if elements != nil {
	...
	if id != nil {
		tmp167 := strconv.Itoa(*id)
		values.Set("_id", tmp167)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp168 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp168)
	}
	if list != nil {
	...
	if fail != nil {
		tmp169 := strconv.FormatBool(*fail)
		values.Set("fail", tmp169)
	}
...
// Creates a valid JWT
func (c *Client) SigninJWT(ctx context.Context, path string, payload *SigninJWTPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Response, error) {
	req, err := c.NewSigninJWTRequest(ctx, path, payload, contained, containedType, count, elements, has, id, include, lastUpdate, list, profile, query, revinclude, security, sort, summary, tag, text, type_)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewSigninJWTRequest(ctx context.Context, path string, payload *SigninJWTPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp170 := strconv.Itoa(*count)
		values.Set("_count", tmp170)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp171 := strconv.Itoa(*id)
		values.Set("_id", tmp171)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp172 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp172)
	}
	if list != nil {
		values.Set("_list", *list)
	}
...
// Signup user
func (c *Client) SignupJWT(ctx context.Context, path string, payload *SignupJWTPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Response, error) {
	req, err := c.NewSignupJWTRequest(ctx, path, payload, contained, containedType, count, elements, has, id, include, lastUpdate, list, profile, query, revinclude, security, sort, summary, tag, text, type_)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewSignupJWTRequest(ctx context.Context, path string, payload *SignupJWTPayload, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	var body bytes.Buffer
	err := c.Encoder.Encode(payload, &body, "*/*")
	if err != nil {
		return nil, fmt.Errorf("failed to encode body: %s", err)
	...
	if count != nil {
		tmp173 := strconv.Itoa(*count)
		values.Set("_count", tmp173)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp174 := strconv.Itoa(*id)
		values.Set("_id", tmp174)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp175 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp175)
	}
	if list != nil {
		values.Set("_list", *list)
	}
...
func (c *Client) UnsecureJWT(ctx context.Context, path string, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Response, error) {
	req, err := c.NewUnsecureJWTRequest(ctx, path, contained, containedType, count, elements, has, id, include, lastUpdate, list, profile, query, revinclude, security, sort, summary, tag, text, type_)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewUnsecureJWTRequest(ctx context.Context, path string, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
	...
	if count != nil {
		tmp176 := strconv.Itoa(*count)
		values.Set("_count", tmp176)
	}
	if elements != nil {
		values.Set("_elements", *elements)
	}
	...
	if id != nil {
		tmp177 := strconv.Itoa(*id)
		values.Set("_id", tmp177)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp178 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp178)
	}
	if list != nil {
		values.Set("_list", *list)
	}
