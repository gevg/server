...
//
// API "Secure": health Resource Client
//
...
func (c *Client) NewHealthHealthRequest(ctx context.Context, path string, contained *string, containedType *string, count *int, elements *string, has *string, id *int, include *string, lastUpdate *time.Time, list *string, profile *string, query *string, revinclude *string, security *string, sort *string, summary *string, tag *string, text *string, type_ *string) (*http.Request, error) {
	...
	if count != nil {
		tmp163 := strconv.Itoa(*count)
		values.Set("_count", tmp163)
	}
	if elements != nil {
	...
	if id != nil {
		tmp164 := strconv.Itoa(*id)
		values.Set("_id", tmp164)
	}
	if include != nil {
		values.Set("_include", *include)
	}
	if lastUpdate != nil {
		tmp165 := lastUpdate.Format(time.RFC3339)
		values.Set("_lastUpdate", tmp165)
	}
	if list != nil {
