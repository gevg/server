...
type PatientStorage interface {
	...
	ListPatient(ctx context.Context) []*app.Patient
	OnePatient(ctx context.Context, id int) (*app.Patient, error)

	ListPatientLink(ctx context.Context) []*app.PatientLink
	OnePatientLink(ctx context.Context, id int) (*app.PatientLink, error)

	ListPatientTiny(ctx context.Context) []*app.PatientTiny
	OnePatientTiny(ctx context.Context, id int) (*app.PatientTiny, error)
}
