...
// ListNutritionRequestOKTiny runs the method List of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListNutritionRequestOKTiny(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.NutritionRequestController, patientID int, years []int) (http.ResponseWriter, app.NutritionRequestTinyCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt app.NutritionRequestTinyCollection
	if resp != nil {
		var ok bool
		mt, ok = resp.(app.NutritionRequestTinyCollection)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.NutritionRequestTinyCollection", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
...
// ShowNutritionRequestOKFull runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowNutritionRequestOKFull(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.NutritionRequestController, patientID int, nutritionRequestID int) (http.ResponseWriter, *app.NutritionRequestFull) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt *app.NutritionRequestFull
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.NutritionRequestFull)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.NutritionRequestFull", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
...
// ShowNutritionRequestOKTiny runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowNutritionRequestOKTiny(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.NutritionRequestController, patientID int, nutritionRequestID int) (http.ResponseWriter, *app.NutritionRequestTiny) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt *app.NutritionRequestTiny
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.NutritionRequestTiny)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.NutritionRequestTiny", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
